...
//        initMyapi = ApiClient.getRetrofitInterface();
//
//        initMyapi.loginUser(username, password).enqueue(new Callback<LoginResponse>() {
...
//                    //토큰 추가
//                    String authToken = result.getKey();
//                    //CustomSharedPreferences.clear(mContext);
//                    PreferenceManager.setString(mContext, "key", authToken);
////                    apiClient.RetrofitConnection(authToken);
//
