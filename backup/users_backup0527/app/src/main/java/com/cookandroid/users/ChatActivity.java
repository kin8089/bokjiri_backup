...
//        System.out.println("message 저장 확인용: " + chatRequest.getMy_chat());
        Call<ChatResponse> call = ApiClient.getService().chatbot2(authToken,chatRequest);
...
//                    }
            ...
            public void onFailure(Call<ChatResponse> call, Throwable t) {
                chatsmodalArrayList.add(new Chatsmodal("응답이 없습니다", System.currentTimeMillis(),BOT_KEY));
                chatAdapter.notifyDataSetChanged();
            }
        });
    }
