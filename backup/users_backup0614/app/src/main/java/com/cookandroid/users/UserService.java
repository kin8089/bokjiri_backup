...
//    Call<MsgModal> getMessage(@Url String url);
    ...
    @POST("chatting/chat2/")
    Call<ChatResponse> chatbott(@Body ChatRequest chatRequest);
    ...
    @POST("accounts/userinformation/")
    Call<UserInfoResponse> userinfo(@Body UserInfoRequest userInfoRequest);

    @DELETE("accounts/userinformation/")
    Call<Void> delete();
