...
//    public void fuckyou(ChatRequest chatRequest){
//        String fuck = et_fuck.getText().toString();
//        chatRequest.setChat(fuck);
//        Call<ChatResponse> chatResponseCall = ApiClient.getService().chatbot(chatRequest);
...
//    }
    ...
    public void passwordChange(PasswordRequest passwordRequest){
        ...
        Call<PasswordResponse> changeResponseCall = ApiClient.getService().changepassword(mtoken, new_password1, new_password2);
