...
//                .baseUrl("http://3.34.129.89:8000/")
//                .baseUrl("http://192.168.0.28:8000/")
                    .baseUrl("http://ec2-13-209-89-204.ap-northeast-2.compute.amazonaws.com:8000/")
                .client(okHttpClient)
                .build();
    ...
    public static Retrofit RetrofitConnection() {
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(new HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level.BASIC).setLevel
        ...
        initMyapi = retrofit2.create(InitMyapi.class);
        return retrofit2;
    }
    ...
    public static UserService getService2(){
        UserService userService = RetrofitConnection().create(UserService.class);
